---
title: "MBAC 617 -- Decision Modeling with Spreadsheets - Syllabus"
...
- \pagestyle{fancy}
- \fancyhf{}
- \fancyhead[CO,CE]{Syllabus - MBAC 617 - Fall 2022}
- \fancyfoot[LO,LE]{Copyright 2014-2022 William G. Foote}
...
Office hours: &	Tuesday and Friday 130PM-230PM DLS423 \\
Phone/Text: &	917-767-7980 (cell)	\\
...
Several online lectures reside (quite comfortably) in my [\underline{_Informing Decisions_ YouTube channel](https://www.youtube.com/playlist?list=PLQhA-d1xKdQYhnQZ7yIPW-Nlk_0wI1wie). Read the materials, watch the videos (with others!), take away what you need to meet your learning goals.
...
_Better to illuminate than merely to shine; to deliver to others contemplated truths than merely to contemplate._ - St. Thomas Aquinas, _Summa Theologiae, II- II, q. 188, a. 6_
...
Week &	Topic \\ 
\hline
Week 1 &	Spreadsheet engineering I: building simple decision models \\
Week 2 &	Spreadsheet engineering II: multi-variable sensitivity analysis \\
Week 3 &	Optimization I: linear programming decision models \\
Week 4 &	Optimization II: multi-period planning and portfolio selection \\
Week 5 &	Simulation I: primordial waiting time \\
Week 6 &	Simulation II: forecasting extreme claims \\
Week 7 &	Compendium: final case preparation and presentation \\
\hline
\end{tabular}
\end{center}
